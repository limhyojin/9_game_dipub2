...
DungGame.prototype = {
	...
	gameReady : function() {
		...
		this.showMessage(
			...
			'<div style="margin:0;padding:0;"><h1 style="font-size:45px;font-weight:black;margin:0;padding:0; word-spacing:-30px;">LOAD TROLL</h1><p style="line-height:30px;margin:0;padding:0;margin-top:20px; font-family:\'Noto Sans KR\', sans-serif;font-weight:400;">회사원 a씨가 길거리 트롤러를<br> 피해 회사에 지각하지 않게 해주세요! </p></div>' +
			'<div style="font-size:20px; padding:20px 0px; color:red; word-spacing:-5px;">[Press SPACE]</div>'+
